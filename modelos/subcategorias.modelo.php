...
class ModeloSubCategorias{
	...
	static public function mdlMostrar1SubCategoria($tabla, $item, $valor){
	...
	static public function mdlAgregarCategoriaASubCategoria($tabla,$datos){

		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET id_categoria = :id_categoria WHERE id = :id");
