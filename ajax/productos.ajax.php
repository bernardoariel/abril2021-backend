...
class AjaxProductos{
	...
	/*=============================================
  	MODIFICAR VISTA PRODUCTOS
 	=============================================*/	


 	public $idProductoVista;
	public $vistaProducto;

	public function ajaxModificarVistaProducto(){

		$tabla = "productos";

		$item1 = "vista";

		if($this->vistaProducto=="productos"){$valor1 ="catalogo";}else{$valor1 ="productos";}


		// $valor1 = $this->vistaProducto;

		$item2 = "id";
		$valor2 = $this->idProductoVista;	
...
if(isset($_POST["idProductoVista"])){

	$productoVista = new AjaxProductos();
	$productoVista -> idProductoVista = $_POST["idProductoVista"];
	$productoVista -> vistaProducto = $_POST["vistaProducto"];
	$productoVista -> ajaxModificarVistaProducto();
