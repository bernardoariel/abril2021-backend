...
class ControladorComercio{
	...
	static public function ctrMostrarCatalogo($item,$valor){
		...
		$respuesta = ModeloComercio::mdlMostrarCatalogo($tabla,$item, $valor);
	...
	/*=============================================
	UPDATE ver  CATALOGO en el home
	=============================================*/

	static public function ctrUpdateCatalogo($datos){

		$tabla = "landing_datos";

		$respuesta = ModeloComercio::mdlUpdateCatalogo($tabla,$datos);
